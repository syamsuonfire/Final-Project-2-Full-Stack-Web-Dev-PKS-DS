   ...
   <div class="home" id="top">
     ...
     <div class="container">
       <div class="introduce">
         ...
         <p>Book-Review is a website that gives you informations about book around the world. Including its <i>rating</i>, <i>date release</i>, and <i>review</i>. </p>
       </div>
       <Slider/>
       <!-- <div class="container"> -->
       <div class="book_list">
...
.pra-footer{
  height: auto;
  width: 100%;
  /*background: url(warnawarni.png) no-repeat center center;
