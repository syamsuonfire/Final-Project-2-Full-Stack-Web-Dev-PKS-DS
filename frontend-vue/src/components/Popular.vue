<template>
  <div class="popular" id="top">
    <Nav/>
    <div class="now_playing_text">
      <h1 rel="stylesheet"> Popular</h1>
      <ol class="breadcrumb">
    ...
    <div class="container">
      <div class="book_list">
        <div class="row">
          <div class="col-sm-3" v-for= "pop in popular">
            <a href="#" role="button" @click="detailFilm(pop)">
              <router-link :to="'/detail/popular/'+$route.params.id">
                <div class="vote">
                ...
                <div class="title">
                  <p><strong>{{pop.title}}</strong></p>
                </div>
                <img :src="'https://image.tmdb.org/t/p/w500_and_h282_bestv2'+pop.poster_path" alt="">
                <div class="overlay">
...
export default{
  ...
  methods:{
    getAPIpop(){
      axios.get('https://api.themoviedb.org/3/movie/popular?api_key=4cd6d9ef2fca21ddbdba9671f95ae371&language=en-US&page='+this.$route.params.id)
      .then((response) => {
